...
typography:
  ...
  levels:
    hero-h1:      { font: display, size: "clamp(40px,6.4vw,80px)", weight: 600, line: 1.0,  tracking: "-0.035em" }
    cta-h2:       { font: display, size: "clamp(32px,5vw,56px)",   weight: 600, line: 1.05, tracking: "-0.02em" }
...
rounded:
  ...
  mock: "16px"
components:
  button-primary: { bg: accent, text: cream, radius: pill, pad: "14px 28px", weight: 600, hover: "opacity 0.9" }
  button-ink:     { bg: ink,    text: paper, radius: pill, pad: "10px 20px", weight: 500, hover: "opacity 0.9" }
